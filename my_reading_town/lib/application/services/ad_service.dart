...
class AdService {
  ...
  Future<bool> showRewardedAd(BuildContext context, LanguageProvider lang) async {
  ...
  Future<bool> _showTestDialog(BuildContext context, LanguageProvider lang) async {
    final result = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          ...
          style: TextStyle(
              fontSize: 13,
              color: AppTheme.darkText.withValues(alpha: 0.72)),
        ),
        actions: [
          TextButton(
