...
class _SettingsDialogState extends State<_SettingsDialog>
  ...
  void _saveGeneral() {
    ...
    final uErr =
        username.isNotEmpty && username.length < 3 ? minMsg : null;
    final tErr =
        townName.isNotEmpty && townName.length < 3 ? minMsg : null;
    setState(() {
      _usernameError = uErr;
      _townNameError = tErr;
    });
  ...
  Future<void> _rescheduleAllNotifications() async {
    ...
    for (final b in widget.village.placedBuildings) {
      ...
      await notif.scheduleConstructionComplete(
        buildingId: b.id!,
        buildingName: lang.translate('building_name_${b.type}', fallback: b.name),
        remaining: remaining,
  ...
  Widget _buildCurrentTab() {
    switch (_currentTab) {
      case 1: return _buildMusicTab();
      case 2: return _buildNotificationsTab();
      case 3: return _buildDataTab();
      case 4: return _buildInfoTab();
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          _ContactItem(
            icon: const Icon(Icons.email_rounded, size: 20, color: AppTheme.darkPink),
          ...
          const SizedBox(height: 8),
          _ContactItem(
            icon: const FaIcon(FontAwesomeIcons.instagram, size: 18, color: AppTheme.mediumOrange),
            label: context.t('info_instagram'),
            value: '@myreadingtown',
            url: 'https://www.instagram.com/myreadingtown',
            color: AppTheme.mediumOrange,
          ),
          const SizedBox(height: 8),
          _ContactItem(
            icon: const FaIcon(FontAwesomeIcons.facebook, size: 18, color: AppTheme.darkSkyBlue),
            label: context.t('info_facebook'),
            value: '@myreadingtown',
            url: 'https://www.facebook.com/myreadingtown',
            color: AppTheme.darkSkyBlue,
          ),
          const SizedBox(height: 8),
          _ContactItem(
            icon: const FaIcon(FontAwesomeIcons.linkedin, size: 18, color: AppTheme.darkLavender),
...
Future<({Set<String> categories, bool saveToDownloads})?> _showExportOptionsDialog(
...
class _ExportOptionsDialogState extends State<_ExportOptionsDialog> {
  ...
  static final _categoryDefs = [
    ('books_reading', Icons.menu_book_rounded, AppTheme.darkLavender,
        'export_category_books', 'export_category_books_desc'),
    ('resources', Icons.account_balance_wallet_rounded, AppTheme.mediumOrange,
        'export_category_resources', 'export_category_resources_desc'),
    ('village', Icons.holiday_village_rounded, AppTheme.darkMint,
        'export_category_village', 'export_category_village_desc'),
    ('progress', Icons.trending_up_rounded, AppTheme.darkSkyBlue,
        'export_category_progress', 'export_category_progress_desc'),
    ('missions', Icons.task_alt_rounded, AppTheme.mediumOrange,
        'export_category_missions', 'export_category_missions_desc'),
    ('extras', Icons.extension_rounded, AppTheme.darkLavender,
        'export_category_extras', 'export_category_extras_desc'),
  ];
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                            AppTheme.darkText.withValues(alpha: 0.04),
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(
                            color:
              ...
              child: SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () {
                    ...
                    Navigator.pop(context,
                        (categories: _selected, saveToDownloads: _saveToDownloads));
                  },
                ),
              ),
            ),
...
Future<List<Map<String, String>>> _loadNotificationMessages(String locale) async {
  try {
              ...
              children: [
                Text(label,
                    style: TextStyle(
                        fontSize: 11,
                        color:
                            AppTheme.darkText.withValues(alpha: 0.55))),
                Text(
