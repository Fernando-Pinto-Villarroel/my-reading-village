...
class ReadingService {
  ...
  Future<Map<String, dynamic>> logPages(int bookId, int pages, List<Book> books,
    ...
    int coinsEarned =
        (rewardablePages * ReadingRules.coinsPerPage * resourceMultiplier)
            .round();
    int gemsEarned = 0;
    int woodEarned = 0;
    int metalEarned = 0;
    ...
    if (rewardablePages > 0) {
      woodEarned =
          (rewardablePages * ReadingRules.woodPerPage * resourceMultiplier)
              .round();
      metalEarned =
          (rewardablePages * ReadingRules.metalPerPage * resourceMultiplier)
              .round();
    }
  ...
  Future<Book> editSession(int sessionId, int bookId, int newPages,
      int? newTimeMins, List<Book> books,
