...
class BuildingService {
  ...
  static double _computeEffectiveElapsedMs(
      DateTime start, DateTime end, List<ActivePowerup> powerups) {
  ...
  static Duration calculateRealSkipForEffectiveSkip(PlacedBuilding building,
      List<ActivePowerup> powerups, Duration effectiveSkip) {
  ...
  bool isBuildingRoadConnected(PlacedBuilding b, Set<String> walkableTiles,
      List<PlacedBuilding> allBuildings) {
  ...
  Future<bool> moveBuilding(
    ...
    final placement = findValidPlacement(
        newTileX,
        newTileY,
        building.tileWidth,
        building.tileHeight,
  ...
  Future<void> toggleRoad(int x, int y, Set<String> roadTiles,
      Map<String, String> specialTiles) async {
  ...
  Future<void> clearToGrass(int x, int y, Set<String> roadTiles,
      Map<String, String> specialTiles) async {
    final key = tileKey(x, y);
