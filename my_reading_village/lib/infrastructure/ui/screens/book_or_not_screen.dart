...
import 'package:my_reading_village/infrastructure/ui/widgets/common/match_character_role_body.dart';
import 'package:my_reading_village/infrastructure/ui/widgets/popups/minigame_win_screen.dart';
...
class _BookOrNotScreenState extends State<BookOrNotScreen> {
  ...
  Future<void> _loadQuestions() async {
    ...
    final jsonStr =
        await rootBundle.loadString('assets/messages/$locale/book_or_not.json');
              ...
              child: Column(
                children: [
                  ...
                  if (author != null && _showResult && _isCorrect == true) ...[
                    ...
                    _AuthorLabel(
                      label:
                          context.t('by_author').replaceAll('{author}', author),
                    ),
                  ],
                ],
              ),
            ...
            child: Column(
              children: [
                _BinaryChoiceRow(
                  ...
                  leftIcon: Icons.menu_book,
                  rightIcon: Icons.not_interested,
                  onLeftTap: _selectedAnswer == null
                      ? () => _selectAnswer(true)
                      : null,
                  onRightTap: _selectedAnswer == null
                      ? () => _selectAnswer(false)
                      : null,
                  leftState: _buttonState(true),
                  rightState: _buttonState(false),
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  fontWeight: FontWeight.bold,
                  color:
                      isCorrect ? const Color(0xFF2E7D32) : Colors.red.shade700,
                ),
              ),
            ],
          ),
