  ...
  Future<void> _watchAdForTimeSkip() async {
    ...
    if (earned && widget.building.id != null) {
      ...
      sl<NotificationService>().scheduleConstructionComplete(
        ...
        buildingName: lang.translate('building_name_${widget.building.type}',
            fallback: widget.building.name),
        remaining: remaining,
                  ...
                  child: OutlinedButton.icon(
                    ...
                    icon: _watchingAd
                        ? SizedBox(
                            ...
                            child: CircularProgressIndicator(
                                strokeWidth: 2, color: AppTheme.darkSkyBlue),
                          )
                    ...
                    style: OutlinedButton.styleFrom(
                      foregroundColor: canWatchAd
                          ...
                          : AppTheme.darkSkyBlue.withValues(alpha: 0.4),
                      side: BorderSide(
                          color: canWatchAd
