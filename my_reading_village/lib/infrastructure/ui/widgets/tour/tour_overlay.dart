...
class _TourOverlayState extends State<TourOverlay>
  ...
  void initState() {
    ...
    _townNameController =
        TextEditingController(text: widget.initialTownName ?? '');
  ...
  Widget build(BuildContext context) {
    ...
    final showPrev =
        step > 0 && step < kTourStepFarewell && widget.onGoBack != null;
      ...
      children: [
        ...
        if (tapZoneRect != null)
          Positioned(
            ...
            child: GestureDetector(
              onTap: (step == kTourStepBuildHighlight &&
                      widget.onBuildHighlightTap != null)
          ...
          Center(
            child: GestureDetector(
              onTap: () {
                ...
                setState(
                    () => _submittedUsername = _formatFarewellName(username));
